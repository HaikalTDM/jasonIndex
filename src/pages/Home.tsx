...
// import vendors from "@/data/vendors.json" // REMOVED: Using API now
...
import { Map, List, ChevronLeft, ChevronRight, Loader2 } from 'lucide-react'
        ...
        <div className="space-y-6 md:space-y-8">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-20">
                    ...
                    <button onClick={() => window.location.reload()} className="mt-4 text-stone-500 hover:text-stone-800 underline">Try again</button>
                </div>
            ) : (
                <>
                    <FilterBar
